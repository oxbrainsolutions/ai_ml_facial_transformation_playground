...
st.set_page_config(page_title="Facial Transformation Playground", page_icon="images/playground_favicon.png", layout="wide")
...
with col2:
  header_text = '''
    <p class="header_text" style="margin-top: 4em; margin-bottom: 0em; text-align: center;"><span style="color: #FAFAFA; font-family: sans-serif; font-size: 1.8em; ">Facial Detection & Transformation</span></p>
  '''
